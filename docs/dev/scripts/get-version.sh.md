...
- `VERSION_FILE_PATH` is either loaded from the environment or, if it's not present in the environment, it defaults to `src/beans_logging_fastapi/__version__.py`.

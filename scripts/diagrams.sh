...
MODULE_NAME="${MODULE_NAME:-beans_logging_fastapi}"
...
OPTIONS:
    -m, --module-name [NAME]    Module name. Default: 'beans_logging_fastapi'
    -d, --module-dir [DIR]      Module directory. Default: './src/beans_logging_fastapi'
